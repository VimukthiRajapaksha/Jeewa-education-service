    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">University Management</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row row-cols-4 justify-content-around">
          			<div class="card col m-3" th:each="university : ${universityList}">						<img th:src="@{'data:image/png;base64,'+${university.image}}" height="140" class="card-img-top p-2" alt="...">
             			<div class="card-body">
            				<a th:href="@{'/universities/'+${university.id}}">
              					<h5 class="card-title text-center" th:text="${university.name}"></h5>
              				</a>
              				<h6 class="card-subtitle mb-2 text-muted text-center" th:text="${university.country}"></h6>
