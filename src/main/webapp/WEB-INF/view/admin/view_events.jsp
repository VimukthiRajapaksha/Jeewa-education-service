  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Universities, Degrees and Events</div>
      </a>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="row w-100">
			<div class="col-8">
				<h6 class="mt-2 font-weight-bold text-primary">Event Details</h6>
			</div>
			<div class="col d-flex">
				<form th:action="@{/events}" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            		<div class="input-group">
              			<input type="text" th:name="name" class="form-control bg-light border-0 small" placeholder="Search event..." aria-label="Search" aria-describedby="basic-addon2">
              			<div class="input-group-append">
          			...
          			<div class="card col m-3" th:each="event : ${eventList}">
            			...
            			<div class="card-body">
              				...
              				<div class="row card-text mb-2 text-muted text-center">
              					...
              					<div class="row">
              						<p>End&nbsp;</p>
              						<p th:text="${event.endDate}"></p>
              						<p>:</p>
              						<p th:text="${event.endTime}"></p>
              					</div>
              					<div class="row">
              						<p>At&nbsp;</p>
              						<p th:text="${event.venue}"></p>
              					</div>
              				</div>
