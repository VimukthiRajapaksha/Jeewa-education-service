		...
		<div id="content-wrapper">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Add University</h1>
					...
					<form class="mt-4" th:action="@{/universities}" th:object="${university}"
						...
						<div class="form-row">
							<div class="col-md-6 my-2">
								<label for="validationTooltip02">University Name</label> <input
									type="text" th:field="*{name}" class="form-control"
									id="validationTooltip02" placeholder="university name" />
							</div>

							<div class="col-md-6 my-2">
								<label for="validationTooltip02">Country</label> <input
									type="text" th:field="*{country}" class="form-control"
									id="validationTooltip02" placeholder="country" />
							</div>
						</div>
						...
						<div class="d-flex justify-content-end">
							<a href="/universities" class="mx-2 btn btn-light mt-2"> 
